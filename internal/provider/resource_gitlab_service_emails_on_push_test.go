...
func TestAccGitlabServiceEmailsOnPush_basic(t *testing.T) {
	...
	var recipients1 = "mynomberonerecipient@example.com"
	var recipients2 = "mynombertworecipient@example.com"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccGitlabServiceEmailsOnPushConfig(testProject.ID, recipients1),
			...
			{
				Config: testAccGitlabServiceEmailsOnPushConfig(testProject.ID, recipients2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGitlabServiceEmailsOnPushExists(emailsOnPushResourceName, &emailsOnPushService),
...
func testAccGitlabServiceEmailsOnPushConfig(projectID int, recipients string) string {
	return fmt.Sprintf(`
